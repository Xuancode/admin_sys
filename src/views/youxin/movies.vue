<!--
 * @Author: xuanpl
 * @Date: 2020-03-31 13:53:33
 * @LastEditors: xuanpl
 * @LastEditTime: 2020-06-09 13:39:57
 * @Description: file content
 * @FilePath: /vue-element-admin/src/views/youxin/movies.vue
-->
<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="验证码" min-width="150px">
        <template slot-scope="{row}">
